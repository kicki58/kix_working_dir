## [slask/mssql_ado_shapefile2postgres_postgis (backup).fmw](https://github.com/kicki58/kix_working_dir/blob/master/slask/mssql_ado_shapefile2postgres_postgis (backup).fmw)
