## [postgis/postgis_restore_drop_backup_idb/getGeodataFromDbViaPath.fmw](https://github.com/kicki58/kix_working_dir/blob/master/postgis/postgis_restore_drop_backup_idb/getGeodataFromDbViaPath.fmw)
