## [gpkg/gpkg_check_outside_sw/check_outside_from_aggrageted.fmw](https://github.com/kicki58/kix_working_dir/blob/master/gpkg/gpkg_check_outside_sw/check_outside_from_aggrageted.fmw)
