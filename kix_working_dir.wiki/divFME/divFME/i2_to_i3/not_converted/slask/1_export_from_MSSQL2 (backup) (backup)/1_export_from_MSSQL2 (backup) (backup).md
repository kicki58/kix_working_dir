## [divFME/i2_to_i3/not_converted/slask/1_export_from_MSSQL2 (backup) (backup).fmw](https://github.com/kicki58/kix_working_dir/blob/master/divFME/i2_to_i3/not_converted/slask/1_export_from_MSSQL2 (backup) (backup).fmw)
