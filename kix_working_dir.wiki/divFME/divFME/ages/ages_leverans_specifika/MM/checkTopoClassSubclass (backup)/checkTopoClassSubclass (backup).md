## [divFME/ages/ages_leverans_specifika/MM/checkTopoClassSubclass (backup).fmw](https://github.com/kicki58/kix_working_dir/blob/master/divFME/ages/ages_leverans_specifika/MM/checkTopoClassSubclass (backup).fmw)
